...
public class SortingJobs {
    public static void main(String[] args) {
        ...
        jobs.add(j3);
        jobs.add(j4);
//        Collections.sort(jobs, Comparator.comparing(Job::getSubmitAt).thenComparing(Job::getDuration));
    ...
    static void helper(List<Job> jobs, long time){
        ...
        if(!jobs.isEmpty()) helper(jobs, time + maxDuration);
    }
    ...
    static class Job {
        ...
        public boolean equals(Object o) {
            ...
            if (submitAt != job.submitAt) return false;
